...
class TransactionProductListForm(FlaskForm):
    ...
    jumlah = IntegerField('Jumlah', validators=[InputRequired(message="Jumlah produk harus diisi."), NumberRange(min=1, max=50, message="Hanya bisa diisi angka minimal 1.")])
    uuid = HiddenField()

    #def __init__(self, *args, **kwargs):
    #    super(TransactionProductListForm, self).__init__(*args, **kwargs)
